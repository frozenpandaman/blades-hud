...
class Dice extends React.PureComponent<{}, State> {
    ...
    render(){
        const dice = this.state.dice.map((num, index) => {
            return(
                ...
                >
                    <div className="f2">{num.toString().replace("0", "\u22EF")}</div>
                </div>
            )
        });
        ...
        return (
        <div className="mv3">
            <h3 className="tc mv1">&#x1F3B2; dice</h3>
            <div className="tc f7">click to roll</div>
            <div className="mv3"></div>
            <div className="flex" style={{justifyContent:"space-around"}}>
                <a href="#!" className="bg-light-blue ba bw0 ph2 pv1 ma mh1 f3 flex-auto pointer tc"
            ...
            <div className="flex" style={{justifyContent:"space-around"}}>
                <a href="#!" className="bg-light-blue ba bw0 ph2 pv1 ma mh1 f4 flex-auto pointer tc"
                    style={{color:"black", textDecoration:"none"}}
                    onClick = {()=>{
                ...
                <a href="#!" className="bg-light-blue ba bw0 ph2 pv1 ma mh1 f4 pointer tc"
                    style={{color:"black", textDecoration:"none"}}
                    onClick = {()=>{
    ...
    ); // add note (memo) pad support at the bottom, for now
    }
}
